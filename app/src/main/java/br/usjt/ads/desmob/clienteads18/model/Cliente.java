...
public class Cliente implements Serializable {
    ...
    private int id;
    private String nome, email, diretor, lancamento;

    public Cliente(int id, String nome, String email, String diretor, String lancamento) {
    ...
    public String toString() {
        return "Cliente{" + "id=" + id + ", nome='" + nome + '\'' + ", diretor='" + diretor + '\'' + ", lancamento='" + lancamento + '\'' + '}';
    }
}